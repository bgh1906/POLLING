...
public class QCandidate extends EntityPathBase<Candidate> {
    ...
    private static final long serialVersionUID = 597528132L;
    ...
    public final com.polling.core.entity.vote.QVote vote;

    public final NumberPath<Integer> voteTotal = createNumber("voteTotal", Integer.class);
    ...
    public QCandidate(Class<? extends Candidate> type, PathMetadata metadata, PathInits inits) {
        ...
        this.vote = inits.isInitialized("vote") ? new com.polling.core.entity.vote.QVote(forProperty("vote"), inits.get("vote")) : null;
    }
