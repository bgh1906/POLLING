...
function About({ changeModeplus, changeModeminus }) {
  return (
    <div className={styles.homebox}>
      ...
      <Link to="/whypolling" id={styles.sub_text_about2}>
        {" "}
        Why POLLING?{" "}
      </Link>
      <button id={styles.arrow_button} onClick={changeModeminus}>
        <img id={styles.arrow} src={arrow7} alt="arrow" />
      </button>
      <button id={styles.arrow_button} onClick={changeModeplus}>
        <img id={styles.arrow2} src={arrow7} alt="arrow2" />
      </button>
    </div>
  );
}
