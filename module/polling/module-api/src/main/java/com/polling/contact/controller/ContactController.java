...
public class ContactController {
    ...
    public ResponseEntity<Void> save(@CurrentUser MemberDto memberDto, @RequestBody SaveContactRequestDto requestDto) {
    ...
    public ResponseEntity<List<FindContactResponseDto>> getContacts(@CurrentUser MemberDto memberDto) {
        List<FindContactResponseDto> list = contactQueryRepository.findContactByMemberId(memberDto.getId());
    ...
    @GetMapping("/admin")
    @ApiOperation(value = "1:1문의 전체조회")
    public ResponseEntity<List<FindAllContactResponseDto>> getAllContacts(@CurrentUser MemberDto memberDto) {
    ...
    public ResponseEntity<Void> response(@CurrentUser MemberDto memberDto, SaveAnswerRequestDto requestDto) {
