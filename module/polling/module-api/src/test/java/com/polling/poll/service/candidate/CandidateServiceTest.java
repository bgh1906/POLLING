...
public class CandidateServiceTest {
    ...
    public void 후보자에투표실패_0이하의투표() throws Exception{
        ...
        //when
        final CustomException result = assertThrows(CustomException.class, () -> target.addVoteCount(requestDto, 1L));
    ...
    public void 후보자삭제실패_없는후보자() throws Exception{
        ...
        //when
        final CustomException result = assertThrows(CustomException.class, () -> target.deleteCandidate(1L));
    ...
    public void 후보자수정실패_없는후보자() throws Exception{
        ...
        //when
        final CustomException result = assertThrows(CustomException.class, () -> target.modifyCandidate(1L, requestDto));
    ...
    public void 후보자수정실패_허용되지않은상태() throws Exception{
        ...
        //then
        assertThat(result.getCustomErrorResult()).isEqualTo(CustomErrorResult.IMPOSSIBLE_STATUS_TO_MODIFY);
    }
